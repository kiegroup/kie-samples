module github.com/kiegroup/kie-samples/samples/order-swf/operator

go 1.20

require github.com/kiegroup/kogito-serverless-operator/workflowproj v0.0.0-20230615083459-fa96eb61a31b
